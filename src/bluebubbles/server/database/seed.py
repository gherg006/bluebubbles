...
ROLE_SEEDS: tuple[RoleSeed, ...] = (
    ...
    RoleSeed(
        ...
        20,
        STANDARD_PERMISSIONS | {Permission.MANAGE_USERS},
    ),
    RoleSeed(
        "HR",
        "Human-resources operator with delegated user administration",
        30,
        STANDARD_PERMISSIONS | {Permission.MANAGE_USERS, Permission.SEND_ANNOUNCEMENTS},
    ),
    RoleSeed(
        "Administrator",
        "Application administrator",
        40,
        frozenset(Permission) - {Permission.MANAGE_SERVER},
    ),
    RoleSeed(
        "SuperAdministrator",
